...
class settings:
    ...
    AUTH_REGISTER  = os.getenv("AUTH_REGISTER",  "/api/v1/auth/register")
    ...
    # API Key Management
    API_KEY_LIST     = os.getenv("API_KEY_LIST",     "/api/v1/auth/api-keys")
    API_KEY_CREATE   = os.getenv("API_KEY_CREATE",   "/api/v1/auth/api-keys")
    API_KEY_UPDATE   = os.getenv("API_KEY_UPDATE",   "/api/v1/auth/api-keys/{key_id}")
    API_KEY_DELETE   = os.getenv("API_KEY_DELETE",   "/api/v1/auth/api-keys/{key_id}")
    API_KEY_LIST_ALL = os.getenv("API_KEY_LIST_ALL", "/api/v1/auth/api-keys/all")
    API_KEY_SELECT   = os.getenv("API_KEY_SELECT",   "/api/v1/auth/api-keys/select")
